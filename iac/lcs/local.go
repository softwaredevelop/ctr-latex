...
func main() {
	...
	// Main project
	createAndDeployStack(ctx, "ctr", "ctr-latex", "localproject_main", auto.ConfigMap{
	...
	// Mirrored project
	createAndDeployStack(ctx, "gitlab-mirror", "ctr-latex-mirrored", "localproject_mirrored", auto.ConfigMap{
